...
function peg$parse(input, options) {
  ...
  var peg$f5 = function(repeat, e) {
  if (repeat) {
    return new ast.Repetition(repeat, e, location());
  }
  return e;
};
  var peg$f6 = function(min, max) {
    return new ast.Repeat(min || 0, max, location());
  };
  var peg$f7 = function(n) { return new ast.Repeat(n, n); };
  var peg$f8 = function(name) { return rules.addRef(name, location()) };
  var peg$f9 = function(alt) {
  return new ast.Group(alt, location());
};
  var peg$f10 = function(alt) {
  ...
  var peg$f13 = function(prose) {
  return new ast.Prose(prose);
};
  var peg$f14 = function(nums) {
    return new ast.CaseSensitiveString(
      nums.map(b => String.fromCharCode(b)).join(""),
      2,
      location()
    );
  };
  var peg$f15 = function(min, max) {
  ...
  var peg$f17 = function(nums) {
    return new ast.CaseSensitiveString(
      nums.map(d => String.fromCharCode(d)).join(""),
      10,
      location()
    );
  };
  var peg$f18 = function(min, max) {
  ...
  var peg$f20 = function(nums) {
    return new ast.CaseSensitiveString(
      nums.map(x => String.fromCharCode(x)).join(""),
      16,
      location()
    );
  };
  var peg$f21 = function(min, max) {
    return new ast.Range(16, min, max, location());
  };
  var peg$f22 = function(n) {
    return new ast.CaseSensitiveString(String.fromCharCode(n), 10, location())
  };
  var peg$f23 = function(b) { return parseInt(b, 2) };
  var peg$f24 = function(d) { return parseInt(d, 10) };
  var peg$f25 = function(h) { return parseInt(h, 16) };
  var peg$currPos = 0;
  var peg$savedPos = 0;
