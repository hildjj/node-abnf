...
function peg$parse(input, options) {
  ...
  var peg$e13 = peg$literalExpectation("%i", true);
  var peg$e14 = peg$classExpectation([[" ", "!"], ["#", "~"]], false, false);
  var peg$e15 = peg$literalExpectation("%s", true);
  ...
  var peg$e24 = peg$literalExpectation("d", true);
  var peg$e25 = peg$literalExpectation("x", true);
  var peg$e26 = peg$anyExpectation();
  var peg$e27 = peg$classExpectation([["0", "1"]], false, false);
  var peg$e28 = peg$classExpectation([["A", "F"]], false, true);
  ...
  var peg$f2 = function(alts) {
  if (alts.length > 1) {
    return new ast.Alternation(alts, location());
  }
  return alts[0];
};
  var peg$f3 = function(reps) {
  if (reps.length > 1) {
