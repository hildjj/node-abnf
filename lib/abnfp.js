...
function peg$parse(input, options) {
  ...
  const peg$startRuleFunctions = {
    rulelist: peg$parserulelist,
  };
  let peg$startRuleFunction = peg$parserulelist;
  ...
  const peg$e0 = peg$classExpectation(["-", ["0", "9"], ["A", "Z"], ["a", "z"]], false, false, false);
  ...
  const peg$e13 = peg$literalExpectation("%i", true);
  const peg$e14 = peg$classExpectation([[" ", "!"], ["#", "~"]], false, false, false);
  const peg$e15 = peg$literalExpectation("%s", true);
  const peg$e16 = peg$literalExpectation("%", false);
  const peg$e17 = peg$literalExpectation("<", false);
  const peg$e18 = peg$classExpectation([[" ", "="], ["?", "~"]], false, false, false);
  const peg$e19 = peg$literalExpectation(">", false);
  const peg$e20 = peg$literalExpectation("\"", false);
  const peg$e21 = peg$literalExpectation("b", true);
  const peg$e22 = peg$literalExpectation(".", false);
  const peg$e23 = peg$literalExpectation("-", false);
  const peg$e24 = peg$literalExpectation("d", true);
  const peg$e25 = peg$literalExpectation("x", true);
  const peg$e26 = peg$anyExpectation();
  const peg$e27 = peg$classExpectation([["0", "1"]], false, false, false);
  const peg$e28 = peg$classExpectation([["A", "F"]], false, true, false);
  ...
  const peg$e33 = peg$literalExpectation("\r", false);
  ...
  function peg$f1(name, operator, children) {
    if (operator === "=/") {
  ...
  function peg$f6(n) {    return new ast.Repeat(n, n, location());  }
  function peg$f7(min, max) {
    min |= 0;
    if (max === 0) {
      error("max must not be zero");
      return;
  ...
  function peg$f21(min, max) {
    return ast.Range.create(16, min, max, location(), options.utf16);
  }
  function peg$f22(n) {
    return new ast.CaseSensitiveString(String.fromCodePoint(n), 10, location())
  }
  function peg$f23(b) {    return parseInt(b, 2)  }
  function peg$f24(d) {    return parseInt(d, 10)  }
  function peg$f25(h) {    return parseInt(h, 16)  }
